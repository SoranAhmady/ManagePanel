...
function DropDownHeader({Option,defultText,classDirections}) {
    ...
    return (
        ...
        {open && (
          <motion.div initial={{opacity:0,x:-10,h:0}} tabIndex={0} onBlur={()=>(setSelected(defultText),setOpen(false))} animate={{opacity:1,x:0}} transition={{duration:1}} className={`w-[9vw]  h-[11vw] bg-white shadow-[0px_0px_6px_0px_#00000026] absolute ${classDirections} rounded-md text-[#353535] text-[0.8vw] flex flex-col items-center `}>
